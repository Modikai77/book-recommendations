    ...
    <SiteShell>
      <section className="space-y-6">
        <div className="rounded-[2rem] border border-stone-200 bg-white/75 p-6">
          ...
          <h1 className="mt-2 font-serif text-4xl">Promote the best private submissions into the shared catalog.</h1>
        </div>
        <div className="space-y-4">
          {reviewItems.map((item) => (
            <article key={item.title} className="rounded-[1.75rem] border border-stone-200 bg-white/80 p-5">
